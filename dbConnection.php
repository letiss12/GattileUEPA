...
class DBAccess {
    ...
    private const USERNAME = "lscudeleeeeeee";
    ...
    public function openDBConnection() {
        ...
        if (!$this->connection) {
            $ecc = $this->connection->mysqli_connect_error();
            $mess = " C'è stato un errore durante l'apertura del database ";
            $ecc = $ecc.$mess;
            throw new Exception($ecc);
            return false;
        } else {
            return true;
        }
